...
public class DataNapiTambahController implements Initializable {
    ...
    void simpanData(ActionEvent event) {
        ...
        if (noRegis.getText().trim().isEmpty() || namaLengkap.getText().trim().isEmpty() || jenisKelamin.getSelectionModel().getSelectedIndex() < 0 || kamar.getSelectionModel().getSelectedIndex() < 0){
            template_error.warning("Perinagtan","silakan isi semau form ");
        }else{
